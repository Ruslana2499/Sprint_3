...
def test_test_go_to_sauces_section(create_driver_instance):#тест клик по «Соусы»
    ...
    WebDriverWait(driver, 15).until(expected_conditions.element_to_be_clickable(sauces_tab_button))
...
def test_test_go_to_buns_section(create_driver_instance):#тест клик по «Булки»
    ...
    WebDriverWait(driver, 5).until(expected_conditions.element_to_be_clickable(buns_tab_button))
...
def test_test_go_to_fillings_section(create_driver_instance):#тест клик по «Начинки»
    ...
    WebDriverWait(driver, 15).until(expected_conditions.element_to_be_clickable(fillings_tab_button))
